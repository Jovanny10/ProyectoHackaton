			...
			<table id="juez" class="table table-hover table-responsive-sm">
				<thead class="thead-light">
					<tr>
						...
						<th class="text-white" style="background-color: #061a45">Equipo</th>
						<th class="text-white" style="background-color: #061a45">Vertical</th>
						<th class="text-white" style="background-color: #061a45">Proyecto</th>
