				...
				<div class="modal-content">
					<form method="POST">
						...
						<div class="modal-footer">
							...
							<button class="mGuardar btn btn-primary" name="submit" id="Aceptar" type="submit" onclick="editandolider()">Guardar</button>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="modal-dialog" role = "document">
				<div class="modal-content text-center text-danger">
					<div class="modal-body">
						...
						<a href="#" class="btn btn-primary" onclick="eliminandolider()" data-dismiss="modal">si, Aceptar</a>
