...
while($row = mysqli_fetch_array($registro)){
	...
	$eliminar = '<a href=\"#\" class=\"btn btn-danger\" data-toggle=\"modal\" data-target=\"#eliminar\" onclick=\"eliminarhacker('."'".$row['idPersona']."'".')\"><i class=\"fas fa-trash-alt\" aria-hidden=\"true\"></i></a>';
