	...
	<nav class="side-navbar">
		...
		<div class="main-menu">
			...
			<ul id="side-main-menu" class="side-menu list-unstyled">
				...
				<li>
					<a href="index.php?carga=2" aria-expanded = "false"><i class="fas fa-folder-open"></i>Registro</a>
				</li>
				<li>
					<a href="index.php?carga=3" aria-expanded = "false"><i class="fas fa-folder-open"></i>Estado del proyecto</a>
				</li>
				<li>
					<a href="index.php?carga=33" aria-expanded="false"><i class="fas fa-bell"></i> Solicitudes <h5 style="display: inline;"><span class="badge badge-pill badge-danger">8</span></h5></a>
				</li>
			</ul>
		</div>
	</nav>
