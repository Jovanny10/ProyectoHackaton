				  			...
				  			<div class="modal-body">
				  				...
				  				<div class="row">
				  					...
				  					<div class="col-lg-4">
				  						...
				  						<input type="text" class="form-control" name="App" id="App1" onpaste = "alert('No puedes pegar'); return false">
				  					</div>
				  					<div class="col-lg-4">
				  				...
				  				<div class="row">
				  					<div class="col-lg-4">
				  						...
				  						<input type="text" name="facebook1" class="form-control" id="facebook1" onpaste="alert('No puedes pegar');return false" onkeypress="return sololetras(event)">
				  					</div>
				  					<div class="col-lg-4">
				  					...
				  					<div class="col-lg-4">
				  						...
				  						<input type="text" name="habilidad" id="habilidad1" class="form-control">
				  					</div>
				  				</div>
				  				<div class="row">
				  					<div class="col-lg-4">
				  					...
				  					<div class="col-lg-4">
				  						<label for="#">Rol</label>
				  						<select id="rol" name="rol" class="form-control"> -- Seleccionar -- </select>
				  					</div>
				  				</div>
				  				<div class="row">
				  					<div class="col-lg-4">
